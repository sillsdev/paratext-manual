...
**Introduction**  **T**his module explains how to keyboard your draft translations into a project in Paratext 9.
...
## 4.1 Go to a Biblical verse[undefined](https://manual.paratext.org/Training-Manual/Stage-1/KD#41-go-to-a-biblical-verse) {#ed0ea142bd7c4f34a35579aa533179bc}
...
- The keys
	...
	- **F8** (chapter), **F9** (book)
- Try pressing **Ctrl** + any of those keys.  Some may be quite different to what you expeect.
