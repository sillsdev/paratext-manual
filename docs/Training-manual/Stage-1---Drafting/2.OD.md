...
The main Paratext menu is on the title bar and each window (or tab) has its own menu.

</div><div className='notion-spacer' />

<div class='notion-column' style={{width: 'calc((100% - (min(32px, 4vw) * 2)) * 0.29166666666666674)'}}>

![](/notion_imgs/292988024.png)

</div><div className='notion-spacer' />

<div class='notion-column' style={{width: 'calc((100% - (min(32px, 4vw) * 2)) * 0.1666666666666667)'}}>
...
And when it says **≡ Tab**, under **Menu** &gt; **Command** it means click on the tab menu icon, then under the menu (e.g. Tools) click on the command (e.g. Wordlist). The most common Tab is the project menu so it may say **≡** **menu** project.
...
- 1= Text collection
	- **≡ Paratext** menu, under **Paratext** choose **Open Text Collection**, select several resources, click **Right arrow** button, click **OK**. See [2.5](https://manual.paratext.org/next/Training-Manual/Stage-1/OD#25))
- 2 =Your project
