...
This separate project contains your additional text and a read-only copy of your project. Cuando esté listo, puede combinar el proyecto de adiciones a la Biblia de Estudio con su proyecto de traducción en un tercer proyecto.
