...
There are a number of improvements to the Study Bible Additions in Paratext 9.5 listed below. Se documentarán con más detalle en la próxima edición del manual.
