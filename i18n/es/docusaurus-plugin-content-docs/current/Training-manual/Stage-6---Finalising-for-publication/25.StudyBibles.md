...
Hay una serie de mejoras en Paratext 9.5 para adiciones a la Biblia de Estudio que se enumeran más abajo. Se documentarán con más detalle en la próxima edición del manual.
...
Las mejoras de la 9.5 aún no se han aplicado aquí.
