...
2. Utilice la herramienta Vocablos bíblicos
    **(Pestaña ≡**, en **Herramientas** &gt; **Vocablos bíblicos)**
3. Abra la lista
    **(Pestaña ≡**, en **Vocablos bíblicos** &gt; **Seleccione lista de vocablos bíblicos)**
4. Elija la lista **CombinedNTMapBiblicalTerms**
5. Añadir traducciones para todos los nombres
6. Guarda el archivo HTML
    **(Pestaña ≡**, en **Vocablos bíblicos** &gt; **Exportar como HTML)**
7. Escriba un nombre para el archivo
8. Pulse **Guardar**.
9. Rellene el documento Word del compositor tipográfico para los mapas.

### 24.4 Proyecto de introducción al NT/Biblia y al apéndice {#8dbe5d1eded645b4b7399b7445e87c9b}
...
### Apéndice {#23a598a5fd4080bc92c8c3130afa40e0}

- El Apéndice/Apéndices se pueden escribir en los libros XXA, XXB, XXC

O

- Uno de los libros específicos: Fondo (**BAK**), Otros temas (**OTH**), Índice de temas (**TDX**), Índice de nombres (**NDX**)…

:::tip

- Consulte con su compositor tipográfico.
