...
3. \*pestaña \*≡, en **Términos bíblicos** &gt; **Seleccione la lista de términos bíblicos**
4. Elegir MapBiblicalTerms
5. Añadir traducciones para todos los términos
6. **≡ Pestaña**, bajo **Términos bíblicos** &gt; **Exportar como HTML**
7. Escriba un nombre para el archivo
8. Pulse **Guardar**.

### 24.4 Borrador Introducción al NT/Biblia {#8dbe5d1eded645b4b7399b7445e87c9b}
