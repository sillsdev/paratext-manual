...
Puedes utilizar un servidor local dedicado de Paratext Live. Inícialo mediante un comando de línea de comandos. Pide ayuda a tu consultor en tecnología lingüística. Consulta el tema de ayuda:
¿Cómo puedo iniciar un servidor local dedicado de Paratext Live?
