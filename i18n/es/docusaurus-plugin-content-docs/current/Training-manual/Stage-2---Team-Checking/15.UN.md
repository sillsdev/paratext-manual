...
| --------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| El icono tiene un borde **** y un color de fondo amarillo ****.                   | The note has at least one unread comment.                                                                                          |
...
| El icono es un **signo de exclamación negro !** dentro de un **triángulo rojo.**  | Hay un conflicto de fusión de envío/recepción porque dos usuarios han hecho cambios diferentes en el mismo versículo.              |
