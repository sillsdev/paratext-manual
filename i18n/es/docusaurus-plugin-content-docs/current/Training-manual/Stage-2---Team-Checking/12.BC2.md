...
**What we are going to do:**  Most of the checks require that your adminitrator has completed an inventory. En este módulo
...
Before you can run these other basic checks, someone must setup the check. Algunas verificaciones requieren un inventario, otras requieren reglas o configuración.
