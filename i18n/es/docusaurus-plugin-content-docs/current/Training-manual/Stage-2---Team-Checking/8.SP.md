...
A list of words is displayed which have the same type of problem which have already been corrected, in other words. Por ejemplo, if you have already corrected ‘teh’ as ‘the’, and it finds ‘tehm’ it will suggest ‘them’.
