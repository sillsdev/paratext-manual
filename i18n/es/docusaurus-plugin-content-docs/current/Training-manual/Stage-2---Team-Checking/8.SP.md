...
1. Haga clic en **Sí** (para confirmar que no puede deshacer y desa continuar)
...
1. Introduzca letras que suenen igual separadas por / (p. ej. s/sh/z)
...
1. Make corrections as explained above [8.2](/8.SP#66602cff1c654a81ae88a1f8b7e7842f)

1. Click **More items available** to see additional words.

1. Continúe según sea necesario.
...
1. Haga clic en el enlace azul del formulario en mayúsculas

    ![](./589500506.png)

1. Haga clic en el enlace azul correspondiente.
1. _Mostrar_ incorrecto (para ver los versículos)
1. _Las dos formas son aceptables_ (para aceptar ambas formas)
1. _Capitalizar Todo_ (para corregir todas las palabras)
...
1. Haga clic en la línea para ver la palabra en su contexto
1. Haga clic en el estado ortográfico correcto.
...
1. Escriba la nota
1. Asigna la nota según sea necesario y haga clic en **Aceptar**.
