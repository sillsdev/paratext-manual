...
Puede cambiar el texto del segundo panel haciendo clic en el enlace azul de la abreviatura del texto. You can also use the **≡ Tab** under V**iew** menu to change the view (preview, unformatted or standard).
