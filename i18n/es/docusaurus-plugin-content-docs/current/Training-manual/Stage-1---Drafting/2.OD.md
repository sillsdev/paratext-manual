...
In 9.4 there are some improvements to manage layouts. El diseño que haya utilizado recientemente debe aparecer en la parte superior del menú.
...
3. Elige la frecuencia de las comprobaciones
    - _Si un recurso ha cambiado, aparece un punto verde en el icono del menú de Paratext._
