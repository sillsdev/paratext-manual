...
Hay varios vídeos disponibles para ayudarle con los distintos tipos de recursos y la disposición de las ventanas. Below are some suggestions. Haga clic en el enlace para ver el vídeo.
...
In 9.4 there have been some improvements to manage layouts. Your recently used layout should be at the top of the menu.
...
3. Choose how often to check
    - _If a resource has changed, a green dot is shown on the Paratext menu icon._
