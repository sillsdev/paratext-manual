...
6. Click **Send/Receive**.
   - _El ordenador hará una copia de sus archivos. A progress meter will be displayed. A message box will only appear if there are any problems._
...
- Prueba a pulsar **Ctrl** + cualquiera de esas teclas.  Some may be quite different to what you expect.
