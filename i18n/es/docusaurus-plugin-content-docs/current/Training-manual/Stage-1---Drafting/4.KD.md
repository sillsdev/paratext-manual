...
2. Si utiliza Keyman, elija su teclado (por ejemplo, Tchad Unicode) (o para MS-Keyboards elija ES o TR/SQ/TZ/AF…)
...
2. Elija la frecuencia de comprobación
    - _Si un proyecto ha cambiado, se muestra un punto verde en el icono del menú del proyecto._


Para más detalles, consulte [Novedades del menú principal](https://vimeo.com/857678678).
...
### Enviar/Recibir a Internet {#eeef5150739042cebaf6ba88512fe809}
