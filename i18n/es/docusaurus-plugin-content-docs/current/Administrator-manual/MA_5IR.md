...
_**Introducción**_ En este módulo aprenderás a instalar recursos.

_**¿Dónde estamos?**_ Ya ha instalado Paratext 8 y registrado al usuario.

+**¿Por qué es importante?**_ En Paratext 9, los recursos se descargan de la DBL (Biblioteca Bíblica Digital). Normalmente, cada usuario los descarga directamente, pero si la conexión a Internet es limitada, es posible compartir los archivos descargados.
