...
_**Introducción**_ La migración es el proceso de mover un proyecto (incluyendo todos los archivos de configuración) de **Paratext 7** a Paratext 9. Paratext 9 no dispone de función de migración. Sin embargo, todavía es posible hacerlo con Paratext 8. Nota: Paratext 9 puede leer proyectos de Paratext 8.

_**¿Dónde estamos?**_ Ya has instalado Paratext 8 y tienes un proyecto Paratext 7 que quieres utilizar en Paratext 9.

_**¿Por qué es importante?**_ Para que todas las características de Paratext 9 funcionen, su proyecto Paratext 7 debe ser migrado. Paratext 7 y Paratext 9 utilizan servidores diferentes para enviar/recibir, por lo que no habrá forma de compartir un proyecto con usuarios de Paratext 7 y Paratext 8 (o 9) al mismo tiempo. En consecuencia, el antiguo servidor se cerrará a finales de diciembre de 2018. Por eso es importante migrar rápidamente los proyectos.
...
- Haga clic en **Aceptar** para iniciar la migración del proyecto.
  - _Aparecerá el cuadro de diálogo Migrar proyecto compartido._
...
- Haga clic en **Enviar inscripción**
  - _Aparecerá un mensaje diciendo 'Proyecto registrado con éxito.'_
- Volver al paratexto
...
- Pulse **Aceptar**,
  - _el proceso de migración se detendrá,_
