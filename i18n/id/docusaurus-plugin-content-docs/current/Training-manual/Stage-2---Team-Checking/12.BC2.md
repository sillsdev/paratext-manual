...
| **Check**                      | **Setup**                                                                                                                |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Chapter/verse numbers          | tidak ada                                                                                                                |
| Markers                        | tanpa format. (Marker inventory displays all current markers)                                                            |
| Karakter (Kombinasi)           | Character inventory                                                                                                      |
...
| Pengulangan Kata               | Repeated words inventory                                                                                                 |
