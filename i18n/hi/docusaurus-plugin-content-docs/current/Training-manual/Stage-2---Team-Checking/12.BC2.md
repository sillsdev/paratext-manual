...
**परिचय** इस मॉड्यूल में, आप कई अन्य बुनियादी जांच (**अक्षर**, <strong x-id) करना सीखेंगे `1'>विराम चिह्न</strong>, **बड़े अक्षर**, और **दोहराए गए शब्द**। जैसा कि पहले मूल जाँच मॉड्यूल (5 में। [बेसिक चेक 1](https://sillsdev.github.io/paratext-manual/5.BC1)), इन चेक को असाइनमेंट और प्रोग्रेस से चलाना सबसे आसान है। हालाँकि, यदि आप कई पुस्तकों की जाँच करना चाहते हैं, तो आपको **टूल्स** मेनू का उपयोग करना होगा।


**शुरू करने से पहले** आपने अपने अनुवाद को पैराटेक्स्ट 9 में टाइप किया है। सुनिश्चित करें कि आपने अध्याय/आयत की संख्याएँ और मार्कर्स की जांच की है, जैसा कि 5 में वर्णित है। [जारी रखने से पहले बुनियादी जांच 1](https://sillsdev.github.io/paratext-manual/5.BC1), और यह कि आपके व्यवस्थापक ने या तो जांच का सेटअप पूरा कर लिया है या आपके पास है अभी सेटअप करने के लिए.
