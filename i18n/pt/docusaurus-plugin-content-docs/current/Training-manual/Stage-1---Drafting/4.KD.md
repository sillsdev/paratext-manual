...
**Por que isso é importante**  Esta é a primeira etapa para inserir sua tradução no computador. Depois que o texto for digitado, você poderá executar várias verificações no conteúdo e formato do texto.
