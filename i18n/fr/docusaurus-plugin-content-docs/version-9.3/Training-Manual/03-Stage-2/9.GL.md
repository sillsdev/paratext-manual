...
:::note 
Vidéo 1A.4b n'est pas été mises à jour pour Paratext 9.3. Bien que les étapes soient très similaires, la version 9.3 a amélioré l'édition du forme de citation et le tri des entrées. Vous n'avez donc pas besoin d'utiliser les solutions de contournement pour modifier le formulaire de citation ou ordonner les entrées du livre GLO.
:::
...
## 9.4 Afficher le livre de glossaire
...
::tip
Il est recommandé d'utiliser l'outil Termes bibliques pour travailler sur les entrées du glossaire. Cependant, il peut être utile d'éditer les définitions à partir du livre GLO.
:::
...
:::tip Paratext 9.3
Vous pouvez désormais modifier le **forme de citation** dans cet onglet sans rompre le lien avec l'entrée.
:::
