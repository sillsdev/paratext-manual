...
Un certain nombre de vidéos sont disponibles pour vous aider à utiliser les différents types de ressources et à disposer les fenêtres. Below are some suggestions. Cliquez sur le lien pour voir la vidéo.
...
:::tip
 ...
 Enhanced resources also contain a dictionary, images, maps, **videos,** etc. Lorsque vous ouvrez une ressource enrichie, un guide s'ouvre également.
