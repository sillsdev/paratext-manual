...
1. Double-cliquez sur l’icône Paratext 9 sur le bureau
    ...
    - **OR**
1. (Dans le menu **Démarrer**, choisissez **Paratext 9<0>)</li> </ol></li> </ul>
...
- 1 = ressources en collection de textes
    - **≡ Paratext** menu, sous **Paratext** choisissez**Ouvrir une collection de texte**, Sélectionnez plusieurs ressources en utilisant la touche Ctrl lorsque vous cliquez sur la ressource. Cliquez sur le **bouton flèche droite**, cliquez **OK**. See [2.5](/2.OD#204f93f95d7e4da7aa004d8b2aefaa86))
- 2 =Your project
...
1. La dialogue "Ouvrir Projet/Ressource s'affiche (voir page suivante)
...
1. Cliquez sur <strong x-id="1">OK</strong>.
