...
Il est suggéré que les ressources soient présentées dans l’ordre de la plus littérale à la moins littérale (pour commencer avec des versions qui ont une correspondance plus forte à la structure de l’original). Parmi les ressources en anglais : ESV, RSV, NIV, NLT. Pour les ressources françaises, l'ordre suivant est suggéré : TOB (si accessible), NVSR78Col, LBS21, BDS, NFC, FRC97, PDV.
