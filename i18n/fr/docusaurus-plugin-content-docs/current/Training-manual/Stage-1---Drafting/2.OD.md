...
Il est suggéré que les ressources soient présentées dans l’ordre de la plus littérale à la moins littérale (pour mettre l’accent sur les textes les plus liés aux textes sources). Parmi les ressources en anglais : ESV, RSV, NIV, NLT. Pour les ressources en français, l’ordre suivant est suggéré : NVRS78Col, LBS21, BDS, FCR19DBL, FRC97, PDV.
