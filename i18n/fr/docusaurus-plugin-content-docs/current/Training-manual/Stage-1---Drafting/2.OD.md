...
**Avant de commencer** Vous vous apprêtez à saisir du texte dans un projet existant. Avant de pouvoir faire ceci, Paratext 9 et les ressources diverses doivent avoir été installés et un projet pour vos données doit avoir été créé.
...
[**0.2.2a**](https://vimeo.com/419872321) Comment ouvrir et modifier une collection de textes fr https://vimeo.com/419872321

[**0.2.3a**](https://vimeo.com/382483908) Comment contrôler les fenêtres qui défilent ensemble fr https://vimeo.com/424066973

[**0.2.3c**](https://vimeo.com/377612971) Comment éxchanger un texte dans une fenêtre https://vimeo.com/433948282 fr https://vimeo.com/433948282

[**0.2.3d**](https://vimeo.com/419314037) Autres astuces sur la disposition des fenêtres fr https://vimeo.com/419314037
...
La version 9.4 a apporté quelques améliorations à la gestion des dispositions de fenêtres. Votre dernière disposition de fenêtres utilisée doit figurer en haut du menu.
...
- 1 = ressources en collection de textes
  - **≡ Paratext** menu, sous **Paratext** choisissez**Ouvrir une collection de texte**, Sélectionnez plusieurs ressources en utilisant la touche Ctrl lorsque vous cliquez sur la ressource. (Voir [2.5](/2.OD#204f93f95d7e4da7aa004d8b2aefaa86))

- 2 = votre projet
  - **≡ Menu Paratext**, sous **Paratext** > **Ouvrir**
...
- Arrangez les fenêtres comme vous le souhaitez. Regardez les vidéos Paratext 0.2.1b, 0.2.1c et 0.2.3d.
...
### Enregistrer la disposition de fenêtres {#d4ebb0ef8d0f49998351a50a09b5942b}
...
1. **≡ Paratext** sous **Disposition de fenêtres** > **Gérer les dispositions de fenêtres**
   - _Une boîte de dialogue s'affiche avec une liste de toutes les dispositions enregistrés_
2. Cliquez sur les trois points à droite du nom de la disposition de fenêtres enregistrée.
   - _Un sous-menu s'affiche._
3. Choisir **Supprimer** dans le sous-menu
   - _Une boîte de dialogue s'affiche vous avertissant que vous allez supprimer la disposition de fenêtres._
...
3. Choisir la fréquence des vérifications
   1. _Si une ressource a été modifiée, un point vert apparaît sur l'icône du menu Paratext._
...
3. Cliquez sur **OK**.
   - _La collection de texte s'affiche_.
...
Il est suggéré que les ressources soient présentées dans l’ordre de la plus littérale à la moins littérale (pour commencer avec des versions qui ont une correspondance plus forte à la structure de l’original). Parmi les ressources en anglais : ESV, RSV, NIV, NLT. Pour les ressources françaises, l'ordre suivant est suggéré : TOB (si accessible), NVSR78Col, LBS21, LBS21, BDS, NFC, FRC97, PDV.
...
1. Utilisez les boutons fléchés pour modifier l'ordre si nécessaire
...
5. **Affichage** > choisir une langue (p. ex.
