...
Il est suggéré que les ressources soient présentées dans l’ordre de la plus littérale à la moins littérale (pour commencer avec des versions qui ont une correspondance plus forte à la structure de l’original). Parmi les ressources en anglais : ESV, RSV, NIV, NLT. Pour les ressources en français, l’ordre suivant est suggéré : NVRS78Col, LBS21, BDS, FCR19DBL, FRC97, PDV.
