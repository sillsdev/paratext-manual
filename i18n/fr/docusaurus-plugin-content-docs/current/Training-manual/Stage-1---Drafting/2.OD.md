...
Il est suggéré que les ressources soient présentées dans l’ordre de la plus littérale à la moins littérale (pour commencer avec des versions qui ont une correspondance plus forte à la structure de l’original). Parmi les ressources en anglais : ESV, RSV, NIV, NLT. For French resources, the following order is suggested: TOB (if accessible), NVSR78Col, LBS21, LBS21, BDS, NFC, FRC97, PDV.
