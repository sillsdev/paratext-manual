...
- _La barre de titre doit comporter le mot (__**Modifiable****)._
...
2. Si vous utilisez Keyman, choisissez votre clavier (par exemple Tchad Unicode) (ou pour les claviers MS, choisissez AF ou TR/SQ/TZ/AF…)
...
5. Ajouter un marqueur de paragraphe après le texte (par exemple : \\ p)
...
1. **≡ Tab**, sous **Insérer** > **Note de bas de page**
    - _Une série de marqueurs de note de bas de page est ajoutée dans la boîte située sous le texte_
...
2. Choisissez la fréquence de vérifier
    - _Si un projet a changé, un point vert s'affiche sur l'icône du menu du projet._


Pour plus de détails, consultez [What's new main menu](https://vimeo.com/857678678).
...
### Envoyer/Recevoir ce projet vers Internet {#eeef5150739042cebaf6ba88512fe809}
...
- Cliquez sur l'icône Envoyer/Recevoir
    - _Paratext fera envoyer/recevoir immédiatement._
