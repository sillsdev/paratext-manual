...
1. Cliquez sur + pour marquer le prochain chapitre comme achevé. Pour marquer d'autres chapitres comme achevé, vous pouvez cliquer sur le mot **Achevé [2]**
...
1. Fermez le résultat de la liste (si vous le souhaitez).
...
1. Passer à **Toutes les tâches** vue
1. Passez au-dessus d'un vérification qui a des problèmes
