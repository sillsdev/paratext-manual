...
1. Double-cliquez sur l'icône de la remarque (dans la deuxième colonne)

    ![](./1114898633.png)

1. Saisissez la remarque
1. Confiez la remarque si nécessaire.
1. Cliquez sur **OK**.
...
1. Double-cliquez sur la terme. Saisissez l’équivalent décidé dans les remarques de la boîte de dialogue. Cliquez sur **OK**
...
1. Cliquez à droit de la souris sur un lemme (mot bleu) dans la fenêtre de texte en langue source

1. Choisissez **Ajouter aux termes bibliques du projet**. Choisissez votre projet

1. Modifiez la glose si nécessaire.

1. Cliquez sur l’onglet Avancé. Modifier la terme si nécessaire. Cliquez sur **OK**
...
1. Cliquez sur l’onglet Avancé. Saisissez un nom pour le terme. Cliquez sur **OK**
