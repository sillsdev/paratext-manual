...
:::tip Identifier et corriger tous les signes de ponctuation inadmissibles ou mal placés. (Use the Unicode character column to clearly identify the punctuation.)
...
| Marqueurs                                        | aucun. (Marker inventory displays all current markers)                                                                   |
| Caractères (combinaisons)                        | Inventaire de caractères                                                                                                 |
| Ponctuation                                      | Punctuation inventory<br/>Markers Missing Final Sentence Punctuation                                               |
...
| Erreurs de ponctuation en paires correspondantes | Unmatched pairs of punctuation inventory                                                                                 |
| Citations                                        | **≡ Tab**, under **Project Setting** > **Quotation rules**                                                               |
| Nombres                                          | **≡ Tab**, under **Project Setting** > **Number settings**                                                               |
| Références                                       | **≡ Tab**, under **Project Setting** > **Scripture reference settings**                                                  |
| Texte cité                                       | aucun                                                                                                                    |
