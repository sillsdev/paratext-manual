...
**Introduction**  In this module, you will learn to do several other basic checks (**Characters**, **punctuation**, **capitals**, and **repeated words**. Comme dans le premier module Vérifications de base (5. [Vérifications de base 1](https://manual.paratext.org/5.BC1/{#584144d4a3454570845a09cb69b1318f}), il est plus facile d'exécuter ces vérifications à partir des Tâches et avancement. Toutefois, si vous souhaitez vérifier plusieurs livres, vous devez utiliser le menu **Outils**.
