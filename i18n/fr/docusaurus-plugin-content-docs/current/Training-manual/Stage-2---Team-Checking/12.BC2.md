...
1. **≡ Onglet**, sous **Outils** &gt; **Inventaires des vérifications** &gt; **Inventaire d'erreurs de ponctuation en paires correspondantes :</0>:</li>
2 Si la liste est vide, il n’y a pas d’erreurs.
3 Si nécessaire, cliquez sur **Options…** pour ajouter d'autres paires</ol>
