...
1. Tapez la correction dans la case ou sélectionnez le mot correct dans la liste
...
1. Effectuer les corrections comme expliqué ci-dessus [8.2](/8.SP#66602cff1c654a81ae88a1f8b7e7842f)

1. Cliquez sur **Davantage d’éléments disponibles** pour afficher d'autres mots.
...
1. Choisissez la vérification souhaitée (voir les descriptions ci-dessous)
...
1. Lorsque la liste est terminée, un message s'affiche
...
Une liste de mots s'affiche qui vous montre les mêmes types de problèmes qui ont déjà été corrigés ailleurs. Par ex. si vous avez déjà corrigé "teh" en "the", et qu'il trouve "tehm", il suggérera "them".
...
1. Confiez la note si nécessaire et cliquez sur **OK**.
