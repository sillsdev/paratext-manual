...
1. Choisissez votre texte de référence comme le **texte comparatif**. Cliquez sur **Paramètres**

1. Tapez les créateurs de paragraphes à afficher
(par exemple, p m)

1. Cliquez sur **OK**.

1. Cliquez sur le lien bleu pour corriger des problèmes vus.
...
1. Retournez aux listes récapitulatives en cliquant sur l'icône dans la barre des tâches.
