...
Dans Paratext 9.4, il y a une option pour **afficher/masquer les remarques de projet.**

- **≡ Projet** sous **View &gt; Show Project Notes**.
    - _Les icônes de notes sont affichées ou masquées._
...
2. **≡ Onglet**, sous **Insérer** > **Remarques**

3. Choisissez l'étiquette souhaitée pour la remarque dans la liste

4. Saisissez le texte de la remarque.

5. Cliquez sur **OK**.
    - _Une icône s’affiche à côté du texte._
...
4. Cliquez sur le bouton **Ajouter étiquette**
...
4. Cliquez sur **Nom** et saisissez un nom
...
2. Cliquez sur la petite poubelle
...
### **Barre d'outils de la liste des remarques** {#16ec056e5f1a44c18f715698dcfd0baa}
...
Paratext 9,5 a ajouté d'un filtre **"Non lu et non résolu"** à la **Liste des remarques**.
...
## 15.4 Ajouter des commentaires dans une liste des remarques {#229174addf7e4280a3da1b08d9b11d7c}
...
Vous pouvez également cliquer sur le lien **Ouvrir** pour ouvrir la fenêtre de la note.
