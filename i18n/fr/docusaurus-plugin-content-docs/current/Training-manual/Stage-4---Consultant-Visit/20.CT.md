...
You can use a Local dedicated Paratext Live server. Start it using a command line command. Ask your LangTech consultant for assistance. See Help topic:
How do I start a local dedicated Paratext Live server?
