...
1.  L'option **Activer le glisser-déposer dans les fenêtres de texte** n'est pas sélectionné.
...
1. Sélectionnez d'abord le mot ou la phrase désirés.
...
1. Sélectionnez un ou plusieurs termes bibliques (en utilisant le clic Ctrl ou Maj (Shift)).
1. Ouvrez le **menu** de la fenêtre.
