...
| **Check**                      | **Setup**                                                                                                                |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Chapter/verse numbers          | ഒന്നുമില്ല                                                                                                               |
| Markers                        | ഒന്നുമില്ല. (Marker inventory displays all current markers)                                                              |
| പ്രതീകങ്ങള്‍ (കോമ്പിനേഷനുകള്‍) | Character inventory                                                                                                      |
