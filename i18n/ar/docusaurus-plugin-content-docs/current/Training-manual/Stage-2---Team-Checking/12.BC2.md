...
| **Check**                      | **Setup**                                                                                                                |
| ------------------------------ | ------------------------------------------------------------------------------------------------------------------------ |
| Chapter/verse numbers          | لا يوجد                                                                                                                  |
| Markers                        | لا شيء. (Marker inventory displays all current markers)                                                                  |
| المحارف (المجموعات)            | Character inventory                                                                                                      |
...
| كلمات مكررة                    | Repeated words inventory                                                                                                 |
